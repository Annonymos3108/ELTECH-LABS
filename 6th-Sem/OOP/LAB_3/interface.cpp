    ...
    : QWidget(parent)
{
    ...
    a_denominator = new QLineEdit("2", this);
    ...
    b_denominator = new QLineEdit("2", this);
    ...
    c_denominator = new QLineEdit("2", this);
    ...
    x_denominator = new QLineEdit("2", this);
    ...
    output->setGeometry(30,200,280,25);
